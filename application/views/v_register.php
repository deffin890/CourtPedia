...
<body>
    ...
    <div class="row rows">
        <div class="col-sm-6 text-center abc">
            <!-- Default form login -->
            <form action="<?= site_url('LoginController/addUser')?>" method="post">
                ...
                <input type="text" class="form-control mb-3" placeholder="Nomor Telp" name="telp" required>
                ...
                <!-- Sign in button -->
                <button class="btn btn-block mt-4" type="submit">REGISTER</button>
        ...
        <div class="col-sm-6 xyz text-center" style="background-image: url(<?= base_url('lib/img/basketball.png')?>)">
